...
@section('content')
     ...
     <div class="row widget-bg-color-white no-space margin-bottom-20">
              <form role="form" id="skills" name="skills">
                        	...
                        	<div class="portlet-body form">
                                    ...
                                    <div class="form-body">
                                        <div class="form-group form-md-line-input">
                                            <input type="text" class="form-control" value="{{ $skill->name }}" id="name" name="name" placeholder="Enter your name">
                                                ...
                                                <select class="form-control" id="user_id" name="user_id">
                                                    <option value=""></option>
                                                     @foreach ($users as $user)
                                                        @if($user->firstname.$user->last_name != "")
                    ...
                    <div class="col-md-3 col-sm-6 no-space">
                        <!-- BEGIN WIDGET SUBSCRIBE -->
                       	     <div id="preview" style="background: url({{ $skill->photo }}) no-repeat" class="widget-gradient margin-top-20">
                        </div>
