                    ...
                    <div class="col-md-3 col-sm-6 no-space">
                        <!-- BEGIN WIDGET SUBSCRIBE -->
                                    <div class="portlet-body form">
                                         ...
                                         <div class="form-body">
                                            <div class="form-group form-md-line-input">
                                                <input v-on:blur="SaveCompanyDetail('contact_name', company.contact_name , $event )" type="text" class="form-control tm-large-field" id="contact_name" v-model="company.contact_name" name="contact_name" placeholder="Enter your name">
